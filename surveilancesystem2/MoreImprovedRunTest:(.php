...
function runTest($s_lat,$s_lon,$d_lat,$d_lon) {
	...
	$dlon=100;
	$dlat=100;
	$distance_source_dest = calculate_distance($s_lon, $s_lat, $d_lon, $d_lat);
	//LOOP
	foreach ($items as $item)
	{
		...
		$distance_end_dest = calculate_distance($current_lon, $current_lat, $d_lon, $d_lat);				
		$distance_end_source = calculate_distance($s_lon, $s_lat, $current_lon, $current_lat);
...
public function calculate_distance($prev_lon, $prev_lat, $current_lon, $current_lat)
{
