...
function find_nearest_node($s_lon,$s_lat,$d_lon,$d_lat,$a_lon,$a_lat,$lonlat,$mid_lon,$mid_lat,$radius,$g,$latest_path)
{
   $clicked_node = array();
   ...
   if (is_array($lonlat[0])) {
	   ...
	   {
	   	$distance_check = ($lon-$mid_lon)*($lon-$mid_lon)+($lonlat[1][$id]-$mid_lat)*($lonlat[1][$id]-$mid_lat);
...
function runTest($s_lon,$s_lat,$d_lon,$d_lat,$a_lon,$a_lat,$graph,$lonlat,$mid_lon,$mid_lat,$radius,$latest_path) {
	//read xml
	$result_array = array();
    ...
    $clicked_node = find_nearest_node($s_lon,$s_lat,$d_lon,$d_lat,$a_lon,$a_lat,$lonlat,$mid_lon,$mid_lat,$radius,$g,$latest_path);
...
runTest($s_lon,$s_lat,$d_lon,$d_lat,$a_lon,$a_lat,$graph,$lonlat,$mid_lon,$mid_lat,$radius,$latest_path);
